...
use crate::{
    core::{
        meta::{DiscountFactorRequest, ExchangeRateRequest, MarketRequest, Numeric},
...
impl SimpleCashflow {
    ...
    pub fn with_amount(mut self, amount: Numeric) -> SimpleCashflow {
    ...
    pub fn set_amount(&mut self, amount: Numeric) {
        self.amount = Some(amount);
    }
}
