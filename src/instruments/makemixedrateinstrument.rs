...
use super::{
    ...
    traits::{build_cashflows, calculate_outstanding, notionals_vector, CashflowType, Structure}, instrument::RateType,
};
...
impl MakeMixedRateInstrument {
    ...
    pub fn with_disbursements(mut self, disbursements: HashMap<Date, f64>) -> MakeMixedRateInstrument {
    ...
    pub fn with_additional_coupon_dates(mut self, additional_coupon_dates: HashSet<Date>) -> MakeMixedRateInstrument {
